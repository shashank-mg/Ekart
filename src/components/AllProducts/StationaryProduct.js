...
export default class StationaryProduct extends Component {
    render() {
        ...
        return (
            <ProductWrapper className="col-9 mx-auto col-md-6 col-lg-3 my-3">            
                ...
                <ProductConsumer>     
                {value => ( 
                    <div className="img-container p-5" onClick={()=>value.handleStationaryDetail(id)}>
                    ...
                    */}  
                    <button className="btn btn-outline-default" disabled={inCart?true:false} onClick={()=>{value.addStationaryToCart(id)}}>                            
